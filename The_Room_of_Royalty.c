	...
	int main()
{
	...
	int haslighter=0;
			...
			printf("Quest: The Room of Royalty\n Press '1' to begin\n Press '0' to exit\n");
			printf("\n");
			printf("Enter response:");
			intro = scan10();
			if(intro==1)
			{
				printf("The 'Room of Royalty Ritual' is a long lived legend.\n The legend goes as follows");
				printf("\n");
				printf("A room that lies in a cove is hidden until one with a dream ventures for it.\n");
				printf("\n");
				printf("The room has the power to grant any wish.\n However, your wish will only come true if you preform the ritual correctly.\n");
				printf("\n");
				printf("in order to preform the ritual correctly, one must first find the following items:\n");
				printf("\n");
				printf("A candle\n A comforting item\n and a light\n");
				printf("After they find the items and are in the room, they must sit in the King's throne.\n If one should sit in the Queen or the Jack's chair,\n they will never be heard from again.\n");
				printf("\n");
				printf("Do you still want to continue on with this journy, Brave Venture?\n");
				printf("\n");
																							 	...
																							 	if(action==1)
																							 	{
																							 		...
																							 		if(action==1)
																							 		{
																							 			...
																							 			if(action==1)
																							 			{
																											...
																											{
																												printf("\n");
																												printf("You chose to sit in the middle throne:\n As you sit down on the throne the door closes.\n");
																												printf("\n");
